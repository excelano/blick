...
struct BlickShortcuts: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        ...
        AppShortcut(
            intent: BlickCountIntent(metric: .unreadEmails),
            phrases: [
        ...
        AppShortcut(
            intent: BlickCountIntent(metric: .unreadChats),
            phrases: [
        ...
        AppShortcut(
            intent: BlickCountIntent(metric: .remainingMeetings),
            phrases: [
        ...
        AppShortcut(
            intent: BlickCountIntent(metric: .unreadMessages),
            phrases: [

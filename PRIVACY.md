# Blick: Privacy Statement

Blick is an iOS app that reads from and writes to your Microsoft 365 account on your behalf. This document is the canonical statement of what Blick does and does not do with your data. The companion repository is open source so that every claim here is independently verifiable.

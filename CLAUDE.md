...
Azure app registration is named `checkin`.

## Brand

Tatsiana palette — navy `#0D2D5B` + cyan `#00ADEE`. App icons (light, dark, tinted) live at `~/checkin/CheckIn/Assets.xcassets/AppIcon.appiconset/`, sources in `~/checkin/branding/`.
